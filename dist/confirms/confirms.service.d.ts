...
export declare class ConfirmsService {
    ...
    private dataSource;
    constructor(confirmRepository: Repository<Confirm>, cartsService: CartsService, dataSource: DataSource);
    ...
    findOneForUser(id: number, user_id: number, entityManager?: EntityManager | null): Promise<Confirm | null>;
